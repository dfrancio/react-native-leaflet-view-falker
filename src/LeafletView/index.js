...
const LeafletView = ({ renderLoading = () => React.createElement(LoadingIndicator, null), onError, onLoadEnd, onLoadStart, onMessageReceived, mapLayers = DEFAULT_MAP_LAYERS, mapMarkers, mapShapes, mapCenterPosition, ownPositionMarker, zoom = DEFAULT_ZOOM, doDebug = __DEV__, androidHardwareAccelerationDisabled, }) => {
    ...
    return (React.createElement(WebView, { containerStyle: styles.container, ref: webViewRef, javaScriptEnabled: true, onLoadEnd: onLoadEnd, onLoadStart: onLoadStart, onMessage: handleMessage, domStorageEnabled: true, startInLoadingState: true, onError: onError, originWhitelist: ['*'], renderLoading: renderLoading, source: LEAFLET_HTML_SOURCE, allowFileAccess: true, allowUniversalAccessFromFileURLs: true, allowFileAccessFromFileURLs: true, androidHardwareAccelerationDisabled: androidHardwareAccelerationDisabled }));
};
